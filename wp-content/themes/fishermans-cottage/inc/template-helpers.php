 ...
 * @return void
 */
function fc_include( $file, $modified = false ) {
 ...
 * @return void/string
 */
function fc_url( $path = '', $echo = true ) {
  $url = site_url() . $path;
 ...
 * @return void/string
 */
function fc_current_url( $echo = true ) {
 ...
 * @return void
 */
function fc_thumbnail_background( $post_id = null, $size = 'large' ) {
  if ( $post_id == null ) {
    global $post;
    $post_id = $post->ID;
  }
 ...
 * @return void
 */
function fc_custom_background( $field_name, $post_id = null, $size = 'large' ) {
  if ( $post_id == null ) {
    global $post;
    $post_id = $post->ID;
  }
